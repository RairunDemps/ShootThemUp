...
void ASTURifleWeapon::Zoom(bool IsEnabled)
{
    ...
    if (IsEnabled)
    {
        DefaultFieldOfViewAngle = Controller->PlayerCameraManager->GetFOVAngle();
    }

    Controller->PlayerCameraManager->SetFOV(IsEnabled ? ZoomFieldOfViewAngle : DefaultFieldOfViewAngle);
}
...
void ASTURifleWeapon::MakeDamage(const FHitResult& HitResult)
{
    ...
    DamagedActor->TakeDamage(DamageAmount, PointDamageEvent, GetController<AController>(), this);
}
