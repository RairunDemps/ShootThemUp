...
void ASTUPlayerCharacter::CheckCameraOverlap()
{
    ...
    {
        UPrimitiveComponent* const MeshChildGeometry = Cast<UPrimitiveComponent>(MeshChild);
...
void ASTUPlayerCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
    ...
    PlayerInputComponent->BindAxis("MoveAround", this, &ASTUPlayerCharacter::AddControllerYawInput);
    ...
    PlayerInputComponent->BindAction<FOnZoomSignature>("Zoom", IE_Pressed, WeaponComponent, &USTUWeaponComponent::Zoom, true);
    PlayerInputComponent->BindAction<FOnZoomSignature>("Zoom", IE_Released, WeaponComponent, &USTUWeaponComponent::Zoom, false);
}
